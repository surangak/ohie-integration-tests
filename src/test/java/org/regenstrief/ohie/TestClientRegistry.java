...
public class TestClientRegistry extends TestCase {
    ...
    private final static List<String> ENABLED = Util.splitExactIntoList(Util.getProperty("org.regenstrief.ohie.cr.enabledTests"), ';');
    ...
    public void testRegistry() throws Exception {
        ...
        if(ENABLED != null) {
            ...
            for (final String file : files) {
                boolean skip = true;
                for (final String enabled : Util.unNull(ENABLED)) {
