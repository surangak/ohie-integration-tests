...
public class InfoMan {
    ...
    private final static String URL = Util.getProperty("org.regenstrief.ohie.InfoMan.url", "http://iol.test.ohie.org:5001/CSD/csr/anonymous/careServicesRequest");
...
//System.out.println(this.original);
    ...
    public final static void setCredentials(String username, String password) {
        InfoMan.USERNAME = username;
        InfoMan.PASSWORD = password;
    }
    ...
    private final String getFacilitySearch(final FacilityArgs args) throws Exception {
        if (TMP_FACILITY_SEARCH == null) {
            TMP_FACILITY_SEARCH = Util.readFile("/src/test/resources/csdintegration/FacilitySearch.xml");
        }
    ...
    private final String getProviderSearch(final ProviderArgs args) throws Exception {
        if (TMP_PROVIDER_SEARCH == null) {
            TMP_PROVIDER_SEARCH = Util.readFile("/src/test/resources/csdintegration/ProviderSearch.xml");
        }
