...
public class XMLUtil {
    ...
    private static final Log log = LogFactory.getLog(org.regenstrief.util.XMLUtil.class);
    ...
    public final static String PROP_LINE_WIDTH = org.regenstrief.util.XMLUtil.class.getName() + ".lineWidth";
     ...
     * @throws java.io.IOException if an I/O problem occurs while writing the Node
     **/
    ...
    public static void setMinXML(final boolean minXML) {
        org.regenstrief.util.XMLUtil.minXML = minXML;
    }
     ...
     * @throws org.w3c.dom.DOMException if the Document cannot be changed
     */
